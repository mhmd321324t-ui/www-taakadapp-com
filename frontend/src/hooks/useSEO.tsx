...
const PAGE_SEO: Record<string, { title: string; description: string }> = {
  '/': {
    title: 'المؤذن العالمي - مواقيت الصلاة | القرآن الكريم | اتجاه القبلة | أذكار وأدعية',
  ...
  '/prayer-times': {
    title: 'مواقيت الصلاة اليوم - الفجر الظهر العصر المغرب العشاء | المؤذن العالمي',
